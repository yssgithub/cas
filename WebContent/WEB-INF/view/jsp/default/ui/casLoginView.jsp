...
<%-- <c:if test="${not pageContext.request.secure}">
  <div id="msg" class="errors">
    ...
    <p>你现在访问CAS通过不安全的连接。单点登录将不会工作。为了有单点登录工作,您必须以 HTTPS方式登录。</p>
  </div>
</c:if> --%>
...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row btn-row">
      ...
      <input class="btn-submit" name="modifypwd" accesskey="m" value="<spring:message code="screen.welcome.button.modify" />" tabindex="6" type="button" />
